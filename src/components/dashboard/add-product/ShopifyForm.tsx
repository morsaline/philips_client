...
import { UploadCloud } from "lucide-react"; // 👈 modern icon
import { z } from "zod";
...
const schema = z.object({
  shopifyLink: z.string().min(1, "Shopify link is required"),
...
export default function ShopifyForm() {
  ...
  const onFinish = async (values: any) => {
    ...
    setLoading(true);
    try {
      message.success("Shopify Product Added ✅");
      console.log("Shopify product:", values);
    } catch {
